  ...
  card?: {
    binding_values: {
      thumbnail_image_large: {
        image_value: { url: string; height: number; width: number };
      };
    };
  };
};
...
const Skeleton = ({
  ...
  return <div className={cn("rounded-md bg-black/10", className)} {...props} />;
};
...
export const TweetMedia = ({ tweet }: { tweet: EnrichedTweetWithCard }) => (
    ...
    {!tweet.video &&
      ...
      tweet?.card?.binding_values?.thumbnail_image_large?.image_value.url && (
        <Image
          ...
          height={
            tweet.card.binding_values.thumbnail_image_large.image_value.height
          }
          src={tweet.card.binding_values.thumbnail_image_large.image_value.url}
          width={
            tweet.card.binding_values.thumbnail_image_large.image_value.width
          }
        />
      )}
  </div>
...
export const MagicTweet = ({
  ...
  return (
    <div
      className={cn(
        "border-grey relative flex size-full max-w-lg flex-col gap-2 overflow-hidden rounded-lg border bg-black p-4 backdrop-blur-md",
        className,
      )}
      {...props}
    >
